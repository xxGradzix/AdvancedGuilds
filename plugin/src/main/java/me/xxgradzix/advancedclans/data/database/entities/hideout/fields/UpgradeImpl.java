...
public enum UpgradeImpl implements Upgrade {
    ...
    UpgradeImpl(File schemFile, int coolDown, int price, double hologramLocationX, double hologramLocationY, double hologramLocationZ, List<String> loreReview, String upgradeName) {

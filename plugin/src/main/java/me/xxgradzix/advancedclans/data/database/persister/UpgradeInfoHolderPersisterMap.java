...
public class UpgradeInfoHolderPersisterMap extends StringType {
    ...
    public Object javaToSqlArg(FieldType fieldType, Object javaObject) {
        HashMap<Upgrade, UpgradeInfoHolder> myFieldClass = (HashMap<Upgrade, UpgradeInfoHolder>) javaObject;
    ...
    private String getJsonFromItemStackClass(HashMap<Upgrade, UpgradeInfoHolder> map) {
        try {
    ...
    private HashMap<Upgrade, UpgradeInfoHolder>  getItemStackClassFromJson(String data) throws IOException {
        try {
            ByteArrayInputStream inputStream = new ByteArrayInputStream(Base64Coder.decodeLines(data));
            BukkitObjectInputStream dataInput = new BukkitObjectInputStream(inputStream);

            HashMap<Upgrade, UpgradeInfoHolder>  items = (HashMap<Upgrade, UpgradeInfoHolder> ) dataInput.readObject();
            dataInput.close();
            return items;

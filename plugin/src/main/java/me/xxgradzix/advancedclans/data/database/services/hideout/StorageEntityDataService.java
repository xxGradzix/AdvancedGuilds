...
public class StorageEntityDataService {
    ...
    public StorageEntityDataService(PersonalStorageRepository personalStorageRepository, HideoutStorageRepository hideoutStorageRepository) {
        StorageEntityDataService.personalStorageRepository = personalStorageRepository;
        StorageEntityDataService.hideoutStorageRepository = hideoutStorageRepository;
    }

...
public class ExpeditionItemManager {
    ...
    private static void createFoodRation3() {
    ...
    private static void createFoodRation2() {
    ...
    private static void createFoodRation1() {
    ...
    private static void createToolPack1() {
    ...
    private static void createToolPack2() {
    ...
    private static void createToolPack3() {

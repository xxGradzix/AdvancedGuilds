...
//                    Component.text("testtesttesttesttesttesttesttesttesttesttesttesttest||七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七七EloEloelo"))
    ...
    public static void openGuildStoragesGui(Player player) {
        ...
        GuiItem personalStorage = new GuiItem(StorageItemManager.getPersonalStorageItem());
        ...
        for (int i = 0; i< 5; i++) {
            ...
            boolean finalIsUnlocked = isUnlocked;

            expeditionStorage.setAction(e -> {

                if(!finalIsUnlocked) {
                    MessageManager.sendMessageFormated(player, MessageManager.STORAGE_IS_NOT_UNLOCKED, MessageType.CHAT);
                    return;
                }
...
//        int page = 1;
        ...
        GuiItem playerHeadItem = new GuiItem(StorageItemManager.getPermissionItem(StoragePermissionSlotType.HEAD, uuid, permittedPlayers.contains(uuid)));
        GuiItem playerItem = new GuiItem(StorageItemManager.getPermissionItem(StoragePermissionSlotType.CHECK_BOX, uuid, permittedPlayers.contains(uuid)));
            ...
            gui.updateItem(e.getSlot(), StorageItemManager.getPermissionItem(StoragePermissionSlotType.CHECK_BOX, uuid, permittedPlayers.contains(uuid)));
            });
...
//            gui.addItem(playerItem);
        ...
        GuiItem previousPage = new GuiItem(StorageItemManager.getPreviousPage(page != 1));
        previousPage.setAction(e -> {
            if(page == 1) {
                return;
            }
            openPermissionGui(player, playerHideOut, guiNum, page - 1);
        });
        gui.setItem(2, 1, previousPage);

        GuiItem nextPage = new GuiItem(StorageItemManager.getNextPage(page * 7 < clanMembers.size()));
        nextPage.setAction(e -> {
            if(clanMembers.size() <= page * 7) {
                return;
            }
            openPermissionGui(player, playerHideOut, guiNum, page + 1);
        });
        gui.setItem(2, 9, nextPage);

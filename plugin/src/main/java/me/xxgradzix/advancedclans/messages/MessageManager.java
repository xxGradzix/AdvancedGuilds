...
public class MessageManager extends OkaeriConfig {
    ...
    @Comment("storage is not unlocked")
    public static String STORAGE_IS_NOT_UNLOCKED = """
            &cᴍᴀɢᴀᴢʏɴ ɴɪᴇ ᴊᴇꜱᴛ ᴏᴅʙʟᴏᴋᴏᴡᴀɴʏ\s
            &7ᴡᴇᴊᴅź ᴅᴏ ᴘᴀɴᴇʟᴜ ᴀʙʏ ᴡʏᴋᴜᴘɪć ᴍɪᴇᴊꜱᴄᴇ ᴡ ᴍᴀɢᴀᴢʏɴɪᴇ\s
            """;
